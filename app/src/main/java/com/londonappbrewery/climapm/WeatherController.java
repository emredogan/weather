...
public class WeatherController extends AppCompatActivity {
    ...
    final String APP_ID = "ce6a7d2f658ebdbd775c6e15cbb16552";
    ...
    private void getWeatherCurrentLocation() {
        ...
        mLocationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                Log.d("Clima", "OnLocation Changed callback received");
        ...
        client.get(WEATHER_URL, params,new JsonHttpResponseHandler() {
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
               // super.onFailure(statusCode, headers, throwable, errorResponse);
                ...
                Log.e( "Clima", " " + statusCode);
                Toast.makeText(WeatherController.this, "Fail", Toast.LENGTH_SHORT).show();
